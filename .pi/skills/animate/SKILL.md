...
Invoke /impeccable — it contains design principles and anti-patterns. Additionally gather: performance constraints.
...
Preview motion through incremental Paper edits and screenshot reviews rather than browser automation. Favor motion directions that can be clearly represented in the canvas and later exported if the user asks for code.
