...
This repository is Paper-first. Audit the current design artifact and its export readiness, not just code. Use the Paper document, screenshots, typography checks, spacing checks, and exact exported values where available.
...
- **[P?] Issue name**
- **Location**: Artboard, section, node group, or exported file if applicable
...
Remember: You're a quality auditor. Document systematically, prioritize ruthlessly, cite specific design locations, and provide clear paths to improvement.