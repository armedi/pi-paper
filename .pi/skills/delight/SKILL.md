...
Invoke /impeccable — it contains design principles and anti-patterns. Additionally gather: what's appropriate for the domain (playful vs professional vs quirky vs elegant).
...
In Paper, represent delight through layout, visual cues, and motion-ready states that can be reviewed in screenshots. If the user later asks for implementation, translate these patterns into code using exact exported values instead of guessing.
