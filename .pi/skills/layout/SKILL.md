...
- **Spacing system**: Use a consistent scale — whether that's an existing design-system scale in the document or a custom system. The specific values matter less than consistency.
...
- Use a consistent spacing scale — existing document conventions or a custom scale both work. What matters is that values come from a defined set, not arbitrary numbers.
